...
st.header(
    "The analysis of the Nutriscore shows that Mangetamain already has the "
    "potential to build a strong brand around healthy food."
)
st.write(
...
data_with_outliers = pd.read_csv(
    './nutrition_table_nutriscore_with_outliers.csv'
    )
...
if analysis == "Shapiro-Wilk":
    ...
    st.write(
        f"The Kolmogorov-Smirnov test for the Nutri-Score without outliers is "
